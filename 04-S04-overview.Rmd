...
This section is comprised of a practical adapted from exercises from the core textbook for this course (James et. al 2019) and two demonstrations adapted from material developed by Dr. Tatjana Kecojevic and from exercises from the core textbook:
