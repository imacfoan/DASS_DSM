...
This section consists of two practicals, both of which will use exercises
adapted from the core textbook for this course:  
...
**Throughout these two practicals, you will practice using the functions below. It is
...
+----------------------+----------------------+----------------------+
| `c                   | convert column to    | tidyverse            |
| olumn_to_rownames()` | row names            |                      |
+----------------------+----------------------+----------------------+
...
+----------------------+----------------------+----------------------+
| `group_by()`         | group by one or more | tidyverse (dplyr)    |
|                      | variables            |                      |
+----------------------+----------------------+----------------------+
...
+----------------------+----------------------+----------------------+
| `ggplot()`           | generic function for | tidyverse (ggplot2)  |
|                      | creating a plot      |                      |
+----------------------+----------------------+----------------------+
...
|                      | over list or vector  |                      |
+----------------------+----------------------+----------------------+
| `select()`           | keep or drop columns | tidyverse (dplyr)    |
|                      |                      |                      |
|                      |                      | *note that this      |
|                      |                      | function is also     |
|                      |                      | available through    |
...
To access the `Boston` dataset, simply type the name of the data object into the console or use `View()`
...
<img src="01-S01_files/figure-html/unnamed-chunk-23-1.png" width="672" />
